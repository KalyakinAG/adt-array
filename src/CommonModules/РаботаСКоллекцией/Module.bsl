...
Функция СтруктураВДеревоЗначений(ДеревоJSON, НайтиСсылку = Ложь) Экспорт
	Если ТипЗнч(ДеревоJSON) = Тип("Строка") Тогда
		Возврат СтруктураВДеревоЗначений(ОбщийКлиентСервер.JSONВЗначение(ДеревоJSON,, Ложь), НайтиСсылку);
	КонецЕсли;
...
Функция ВJSON(Коллекция, КрасивоеФорматирование = Ложь) Экспорт
	...
	Если ТипЗначения = Тип("ТаблицаЗначений") Тогда
		...
		Возврат ОбщийКлиентСервер.ЗначениеВJSON(ТаблицаЗначенийВСтруктуру(Коллекция), КрасивоеФорматирование);
		
	ИначеЕсли ТипЗначения = Тип("ДеревоЗначений") Тогда
		
		Возврат ОбщийКлиентСервер.ЗначениеВJSON(ДеревоЗначенийВСтруктуру(Коллекция), КрасивоеФорматирование);
