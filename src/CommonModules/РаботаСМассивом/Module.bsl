...
Функция НовыйГруппировка(ПоляГруппировки = Неопределено, ПоляИтога)
	...
	Для Каждого ИмяПоля Из Массив(ПоляИтога) Цикл
...
Функция Сгруппировать(Элементы, ПоляГруппировки = Неопределено, ПоляИтога = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ПоляГруппировки) Тогда
		...
		Группировка = НовыйГруппировка(, ПоляИтога);
		
		Для Каждого Элемент Из Элементы Цикл
			
			Для Каждого ИмяПоляИтога Из Массив(ПоляИтога) Цикл
	...
	Для Каждого Элемент Из Элементы Цикл
		...
		Группировка = НовыйГруппировка(ПоляГруппировки, ПоляИтога);
