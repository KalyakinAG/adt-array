...
//
Функция Дополнить(МассивПриемник, МассивИсточник, ТолькоУникальныеЗначения = Ложь) Экспорт
...
Функция Разность(МассивПриемник, МассивВычитания) Экспорт
	Возврат ОбщегоНазначенияКлиентСервер.РазностьМассивов(МассивПриемник, МассивВычитания);
КонецФункции
