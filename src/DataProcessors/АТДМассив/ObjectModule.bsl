...
Функция Массив(НовыеЭлементы = Неопределено) Экспорт
	Если НовыеЭлементы = Неопределено Тогда
		Если ТипЗнч(ЭлементыМассива) = Тип("Массив") Тогда
			Возврат ЭтотОбъект;
		КонецЕсли;		
		ЭлементыМассива = РаботаСМассивом.Скопировать(ЭлементыМассива);
		Возврат ЭтотОбъект;
	КонецЕсли;
	ЭлементыМассива = РаботаСМассивом.Скопировать(НовыеЭлементы);
	Возврат ЭтотОбъект;
КонецФункции
...
Функция ОтобразитьСвойства(СоответствиеСвойств, ПутьОтображения = Неопределено) Экспорт
	ЭлементыМассива = РаботаСМассивом.ОтобразитьСвойства(ВМассив(), СоответствиеСвойств, ПутьОтображения);
	Возврат ЭтотОбъект;
КонецФункции

Функция ВставитьСвойство(Свойство, ВыражениеОтображения, Контекст = Неопределено, Параметры = Неопределено) Экспорт
	ЭлементыМассива = РаботаСМассивом.ВставитьСвойство(ВМассив(), Свойство, ВыражениеОтображения, Контекст, Параметры);
	Возврат ЭтотОбъект;
КонецФункции

Функция ВставитьСвойствоРекурсивно(Путь, ВыражениеОтображения) Экспорт
	ЭлементыМассива = РаботаСМассивом.ВставитьСвойствоРекурсивно(ВМассив(), Путь, ВыражениеОтображения);
	Возврат ЭтотОбъект;
КонецФункции
...
Функция Свернуть(ПоляГруппировки = Неопределено, ПоляСвертки) Экспорт
	ЭлементыМассива = РаботаСМассивом.Свернуть(ЭлементыМассива, ПоляГруппировки, ПоляСвертки);
	Возврат ЭтотОбъект;
КонецФункции
